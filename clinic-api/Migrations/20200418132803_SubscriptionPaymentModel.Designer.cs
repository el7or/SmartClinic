...
namespace clinic_api.Migrations
{
    ...
    [Migration("20200418132803_SubscriptionPaymentModel")]
    partial class SubscriptionPaymentModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("clinic_api.Models.DoctorMedicinesValue", b =>
                {
                    ...
                    b.ToTable("DoctorMedicinesValues");
                });
            ...
            modelBuilder.Entity("clinic_api.Models.Plan", b =>
                {
                    ...
                    b.Property<int?>("MaxFilesMonthlyMb")
                        .HasColumnName("MaxFilesMonthlyMB")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("clinic_api.Models.SysMedicineConcentrationsValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SysMedicineConcentrationsValues");
                });
            ...
            modelBuilder.Entity("clinic_api.Models.SysMedicineFormsValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SysMedicineFormsValues");
                });
            ...
            modelBuilder.Entity("clinic_api.Models.PatientPrescription", b =>
                {
                    b.HasOne("clinic_api.Models.SysMedicineConcentrationsValue", "Concentration")
                    ...
                    b.HasOne("clinic_api.Models.SysMedicineFormsValue", "Form")
                        .WithMany("PatientPrescriptions")
                        .HasForeignKey("FormId")
                        .HasConstraintName("FK_PatientPrescriptions_SysMedicineFormsValues");

                    b.HasOne("clinic_api.Models.DoctorMedicinesValue", "Medicine")
                        .WithMany("PatientPrescriptions")
                        .HasForeignKey("MedicineId")
