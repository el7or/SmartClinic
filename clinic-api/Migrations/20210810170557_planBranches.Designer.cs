...
namespace clinic_api.Migrations
{
    ...
    [Migration("20210810170557_planBranches")]
    partial class planBranches
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("clinic_api.Models.DoctorPharmacy", b =>
                {
                    b.Property<Guid>("DoctorId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("clinic_api.Models.PatientPrescription", b =>
                {
                    ...
                    b.Property<bool?>("IsPharmacyDelete")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsPharmacyDone")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("clinic_api.Models.Pharmacy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("clinic_api.Models.Plan", b =>
                {
                    ...
                    b.Property<int?>("MaxBranchesCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("clinic_api.Models.SysDoctorExpenseTypeValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SysDoctorExpenseTypes");
                });
            ...
            modelBuilder.Entity("clinic_api.Models.DoctorPharmacy", b =>
                {
                    b.HasOne("clinic_api.Models.Doctor", "Doctor")
                        .WithMany("DoctorPharmacies")
                        .HasForeignKey("DoctorId")
                        .HasConstraintName("FK_DoctorPharmacies_Doctors")
                        .IsRequired();

                    b.HasOne("clinic_api.Models.Pharmacy", "Pharmacy")
                        .WithMany("DoctorPharmacies")
